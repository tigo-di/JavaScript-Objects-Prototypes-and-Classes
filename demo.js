...
//  person.name.firstName = 'Sofia';
  ...
  //display(createPerson.adultAge);

  // classes has prototype as objects functions do
  // Object.defineProperty(createPerson.prototype, 'fullName', { enumerable: true });


/*
  jim = new createPerson('Jim', 'Cooper', 29); 
//  jim.age = 29;

  display(jim); // dont show getters and setters -> created with enumerable = false
...
*/
  ...
  class Student extends createPerson {
    ...
    constructor (firstName, lastName, age){
      super(firstName, lastName, age); // call constructor class that we are extending
...
*/
  ...
  // 1 of 2: create a Person
  // 2 of 2: create a Student from a Person
  ...
  // All the properties and functions on the Math are statics
  // Don't need to create a new Math object before using it
